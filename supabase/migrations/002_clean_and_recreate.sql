...
DROP TRIGGER IF EXISTS trigger_update_user_follow_counts ON follows;
DROP TRIGGER IF EXISTS trigger_update_activity_participants_count ON activity_participants;
...
DROP FUNCTION IF EXISTS update_activity_participants_count();
...
GRANT SELECT ON activity_participants TO anon, authenticated;
GRANT ALL ON activity_participants TO authenticated;