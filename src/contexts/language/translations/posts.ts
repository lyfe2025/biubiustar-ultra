  ...
  zh: {
    posts: {
      ...
      comments: {
        ...
        closeHint: '按 ESC 键或点击右上角 X 按钮关闭窗口',
        submitError: '发表评论失败，请重试',
        success: '评论发表成功',
        error: '评论发表失败，请重试',
        delete: '删除',
        ...
        deleteError: '删除评论失败，请重试',
        loadError: '加载评论失败，请重试',
        loadTimeout: '加载评论超时，请重试',
        authError: '请先登录后再评论',
        emptyError: '评论内容不能为空',
        networkError: '网络连接失败，请重试',
        permissionError: '没有权限执行此操作',
        tooLongError: '评论内容过长，请缩短后重试',
        tooLongWarning: '评论内容超过 {max} 字符限制'
      },
  ...
  'zh-TW': {
    posts: {
      ...
      comments: {
        ...
        reply: '回復',
        showMore: '顯示更多評論',
        noComments: '暫無評論，來發表第一條評論吧！',
        closeHint: '按 ESC 鍵或點擊右上角 X 按鈕關閉視窗',
        submitError: '發表評論失敗，請重試',
        success: '評論發表成功',
        error: '評論發表失敗，請重試',
        delete: '刪除',
        deleteConfirmTitle: '刪除評論',
        deleteConfirm: '確定要刪除這條評論嗎？',
        deleteSuccess: '評論刪除成功',
        deleteError: '刪除評論失敗，請重試',
        loadError: '加載評論失敗，請重試',
        loadTimeout: '加載評論超時，請重試',
        authError: '請先登錄後再評論',
        emptyError: '評論內容不能為空',
        networkError: '網絡連接失敗，請重試',
        permissionError: '沒有權限執行此操作',
        tooLongError: '評論內容過長，請縮短後重試',
        tooLongWarning: '評論內容超過 {max} 字符限制'
      },
      ...
      messages: {
        createSuccess: '帖子發布成功！',
        createFailed: '帖子發布失敗',
        deleteSuccess: '帖子刪除成功',
        deleteFailed: '帖子刪除失敗',
        likeSuccess: '點讚成功',
        likeFailed: '點讚失敗',
        commentSuccess: '評論發表成功',
        commentFailed: '評論發表失敗'
      },
  ...
  en: {
    posts: {
      ...
      comments: {
        ...
        closeHint: 'Press ESC key or click the X button in the top right to close',
        ...
        loadTimeout: 'Loading comments timed out, please try again',
        authError: 'Please login to comment',
        emptyError: 'Comment content cannot be empty',
        networkError: 'Network connection failed, please try again',
        permissionError: 'You do not have permission to perform this action',
        tooLongError: 'Comment content is too long, please shorten it',
        tooLongWarning: 'Comment exceeds {max} character limit'
      },
  ...
  vi: {
    posts: {
      ...
      comments: {
        ...
        reply: 'Trả lời',
        showMore: 'Hiển thị thêm bình luận',
        noComments: 'Chưa có bình luận nào. Hãy là người đầu tiên bình luận!',
        closeHint: 'Nhấn phím ESC hoặc nhấp vào nút X ở góc trên bên phải để đóng',
        submitError: 'Không thể gửi bình luận, vui lòng thử lại',
        success: 'Bình luận đã được đăng thành công',
        error: 'Không thể đăng bình luận, vui lòng thử lại',
        delete: 'Xóa',
        deleteConfirmTitle: 'Xóa bình luận',
        ...
        loadTimeout: 'Tải bình luận quá thời gian, vui lòng thử lại',
        authError: 'Vui lòng đăng nhập để bình luận',
        emptyError: 'Nội dung bình luận không được để trống',
        networkError: 'Kết nối mạng thất bại, vui lòng thử lại',
        permissionError: 'Bạn không có quyền thực hiện hành động này',
        tooLongError: 'Nội dung bình luận quá dài, vui lòng rút ngắn'
      },
      ...
      messages: {
        createSuccess: 'Đăng bài viết thành công!',
        createFailed: 'Đăng bài viết thất bại',
        deleteSuccess: 'Xóa bài viết thành công',
        deleteFailed: 'Xóa bài viết thất bại',
        likeSuccess: 'Đã thích bài viết',
