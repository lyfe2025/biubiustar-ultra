...
const DebugLanguage = () => {
  ...
  return (
    <div className="container mx-auto p-8">
      ...
      <div className="mb-6">
        <h2 className={headingStyles.h3Simple}>当前语言: {language}</h2>
        <p>LocalStorage 语言设置: {localStorage.getItem('language')}</p>
        <p>浏览器语言: {navigator.language}</p>
      </div>

      <div className="mb-6">
        <h2 className={headingStyles.h3Simple}>翻译测试</h2>
      ...
      <div className="mb-6">
        <h2 className={headingStyles.h3Simple}>直接测试 admin.auth.login.title</h2>
